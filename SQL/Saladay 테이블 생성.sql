...
CREATE TABLE "REVIEW" (
	...
	"REVIEW_IMG"	VARCHAR2(300)	DEFAULT '/resources/images/review/reviewImg.png'	NOT NULL,
...
COMMENT ON COLUMN "REVIEW"."REVIEW_IMG" IS '리뷰 이미지';
