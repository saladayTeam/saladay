...
-- FAQ 샘플 데이터 삽입
INSERT INTO FAQ 
VALUES (SEQ_FAQ_NO.NEXTVAL, '드레싱 별도 구매 가능한가요?', '드레싱의 개별 구매는 불가하신 점 안내드립니다. 구독 결제 시 옵션 추가 구매 가능하나 별도 구매는 이루어지고 있지 않으니 양해부탁드립니다.', DEFAULT);

INSERT INTO FAQ
VALUES (SEQ_FAQ_NO.NEXTVAL, '샐러데이의 식재료는 GMO FREE 인가요?', '샐러데이의 메뉴 제조 시 사용되는 주요 식재료(채소, 드레싱, 가공육 등)는 GMO(유전자 재조합 농산물)를 원료로 사용하지 않은 안심할 수 있는 식품입니다.
                        GMO식품은 과학적으로 위해성이 입증된 적은 없으나 섭취할 경우 인체에 나쁜 영향을 미칠 수 있다는 우려가 있습니다.
                        앞으로도 믿고 드실 수 있는, 건강하고 맛있는 한 끼를 제공하는 샐러데이가 되겠습니다.', DEFAULT);

INSERT INTO FAQ 
VALUES (SEQ_FAQ_NO.NEXTVAL, '닭가슴살에 검은 입자가 보이는데 무엇인가요?', '샐러데이에서 사용 중인 닭가슴살은 ''샐러데이''와 ''CJ제일제당''이 직접 개발한 시즈닝으로 마리네이드 후 조리되는 제품입니다.
                        문의주신, 닭가슴살에 검게 보이는 입자는 흑후추 및 향신료에 포함된 타임, 로즈마리, 레드페퍼, 오레가노 등과 같은 허브류 등이 블렌딩된 시즈닝입니다.
                        닭가슴살의 풍미와 부드러움을 더해주는 시즈닝이므로 안심하고 드셔도 된다는 점 안내드립니다.', DEFAULT);
