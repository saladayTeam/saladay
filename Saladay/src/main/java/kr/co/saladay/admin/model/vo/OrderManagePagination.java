...
public class OrderManagePagination {
	   ...
	   public OrderManagePagination(int listCount, int currentPage) {
	   ...
	   public OrderManagePagination(int listCount, int currentPage, int limit, int pageSize) {
	      this.listCount = listCount;
	      this.currentPage = currentPage;
	      this.limit = limit;
