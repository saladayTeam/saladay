...
public class MemberPagination {
	   ...
	   public MemberPagination(int listCount, int currentPage) {
	   ...
	   public MemberPagination(int listCount, int currentPage, int limit, int pageSize) {
	      this.listCount = listCount;
	      this.currentPage = currentPage;
	      this.limit = limit;
	   ...
	   public String toString() {
	      return "MemberPagination [currentPage=" + currentPage + ", listCount=" + listCount + ", limit=" + limit
