...
<head>
    ...
    <title>옵션 등록</title>
    <link rel="stylesheet" href="/resources/css/admin/menuManage/registOptionPopup.css">
        ...
        <form action="/admin/regist/option" method="POST" enctype="multipart/form-data" id="registFrm" onsubmit="return registValidate();">
            <table class="option-table">
                ...
                <tbody>
                    ...
                    <tr class="t-row">
                        <th><label for="optionType">옵션구분</label></th>
                        <td>
            ...
            <div class="option-btn-area">
                <button id="registBtn"><strong>옵션등록</strong></button>
                <button type="button" id="closeBtn"><strong>취소</strong></button>
            </div> 
        </form>
    </div>
    <script src="https://code.jquery.com/jquery-3.6.1.min.js" integrity="sha256-o88AwQnZB+VDvE9tvIXrMQaPlFFSUTR+nldQm1LuPXQ=" crossorigin="anonymous"></script>
    <script src="/resources/js/admin/menuManage/registOptionPopup.js"></script>
</body>
</html>