...
<div class="left-side">
	...
	<ul class="my-page-list">
		...
		<li>
			...
			<label for="myPageType2"><a href="/member/myPageChangePw" class="myPageType2">비밀번호 변경</a></label>
		</li>
		...
		<li>
			...
			<label for="myPageType4"><a href="/member/myReview" class="myPageType4">나의 리뷰</a></label>
		</li>
